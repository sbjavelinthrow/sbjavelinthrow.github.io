...
!function(e,t){"use strict";"function"==typeof define&&define.amd?define(["doc-ready/doc-ready","matches-selector/matches-selector"],function(n,r){return t(e,n,r)}):"object"==typeof exports?module.exports=t(e,require("doc-ready"),require("desandro-matches-selector")):e.fizzyUIUtils=t(e,e.docReady,e.matchesSelector)}(window,function(e,t,n){"use strict";function r(e){return e.replace(/(.)([A-Z])/g,function(e,t,n){return t+"-"+n}).toLowerCase()}var o={};o.extend=function(e,t){for(var n in t)e[n]=t[n];return e},o.modulo=function(e,t){return(e%t+t)%t};var i=Object.prototype.toString;o.isArray=function(e){return"[object Array]"==i.call(e)},o.makeArray=function(e){var t=[];if(o.isArray(e))t=e;else if(e&&"number"==typeof e.length)for(var n=0,r=e.length;r>n;n++)t.push(e[n]);else t.push(e);return t},o.indexOf=Array.prototype.indexOf?function(e,t){return e.indexOf(t)}:function(e,t){for(var n=0,r=e.length;r>n;n++)if(e[n]===t)return n;return-1},o.removeFrom=function(e,t){var n=o.indexOf(e,t);-1!=n&&e.splice(n,1)},o.isElement="function"==typeof HTMLElement||"object"==typeof HTMLElement?function(e){return e instanceof HTMLElement}:function(e){return e&&"object"==typeof e&&1==e.nodeType&&"string"==typeof e.nodeName},o.setText=function(){function e(e,n){t=t||(void 0!==document.documentElement.textContent?"textContent":"innerText"),e[t]=n}var t;return e}(),o.getParent=function(e,t){for(;e!=document.body;)if(e=e.parentNode,n(e,t))return e},o.getQueryElement=function(e){return"string"==typeof e?document.querySelector(e):e},o.handleEvent=function(e){var t="on"+e.type;this[t]&&this[t](e)},o.filterFindElements=function(e,t){e=o.makeArray(e);for(var r=[],i=0,u=e.length;u>i;i++){var c=e[i];if(o.isElement(c))if(t){n(c,t)&&r.push(c);for(var f=c.querySelectorAll(t),a=0,s=f.length;s>a;a++)r.push(f[a])}else r.push(c)}return r},o.debounceMethod=function(e,t,n){var r=e.prototype[t],o=t+"Timeout";e.prototype[t]=function(){var e=this[o];e&&clearTimeout(e);var t=arguments,i=this;this[o]=setTimeout(function(){r.apply(i,t),delete i[o]},n||100)}};var u=e.jQuery,c=e.console;return o.htmlInit=function(e,n){t(function(){for(var t=r(n),o=document.querySelectorAll(".js-"+t),i="data-"+t+"-options",f=0,a=o.length;a>f;f++){var s,d=o[f],l=d.getAttribute(i);try{s=l&&JSON.parse(l)}catch(p){c&&c.error("Error parsing "+i+" on "+d.nodeName.toLowerCase()+(d.id?"#"+d.id:"")+": "+p);continue}var y=new e(d,s);u&&u.data(d,n,y)}})},o});
!function(t,n){"use strict";"function"==typeof define&&define.amd?define(["eventEmitter/EventEmitter","eventie/eventie"],function(o,e){return n(t,o,e)}):"object"==typeof exports?module.exports=n(t,require("wolfy87-eventemitter"),require("eventie")):t.Unipointer=n(t,t.EventEmitter,t.eventie)}(window,function(t,n,o){"use strict";function e(){}function i(){}i.prototype=new n,i.prototype.bindStartEvent=function(t){this._bindStartEvent(t,!0)},i.prototype.unbindStartEvent=function(t){this._bindStartEvent(t,!1)},i.prototype._bindStartEvent=function(n,e){e=void 0===e?!0:!!e;var i=e?"bind":"unbind";t.navigator.pointerEnabled?o[i](n,"pointerdown",this):t.navigator.msPointerEnabled?o[i](n,"MSPointerDown",this):(o[i](n,"mousedown",this),o[i](n,"touchstart",this))},i.prototype.handleEvent=function(t){var n="on"+t.type;this[n]&&this[n](t)},i.prototype.getTouch=function(t){for(var n=0,o=t.length;o>n;n++){var e=t[n];if(e.identifier==this.pointerIdentifier)return e}},i.prototype.onmousedown=function(t){var n=t.button;n&&0!==n&&1!==n||this._pointerDown(t,t)},i.prototype.ontouchstart=function(t){this._pointerDown(t,t.changedTouches[0])},i.prototype.onMSPointerDown=i.prototype.onpointerdown=function(t){this._pointerDown(t,t)},i.prototype._pointerDown=function(t,n){this.isPointerDown||(this.isPointerDown=!0,this.pointerIdentifier=void 0!==n.pointerId?n.pointerId:n.identifier,this.pointerDown(t,n))},i.prototype.pointerDown=function(t,n){this._bindPostStartEvents(t),this.emitEvent("pointerDown",[this,t,n])};var r={mousedown:["mousemove","mouseup"],touchstart:["touchmove","touchend","touchcancel"],pointerdown:["pointermove","pointerup","pointercancel"],MSPointerDown:["MSPointerMove","MSPointerUp","MSPointerCancel"]};return i.prototype._bindPostStartEvents=function(n){if(n){for(var e=r[n.type],i=n.preventDefault?t:document,p=0,s=e.length;s>p;p++){var u=e[p];o.bind(i,u,this)}this._boundPointerEvents={events:e,node:i}}},i.prototype._unbindPostStartEvents=function(){var t=this._boundPointerEvents;if(t&&t.events){for(var n=0,e=t.events.length;e>n;n++){var i=t.events[n];o.unbind(t.node,i,this)}delete this._boundPointerEvents}},i.prototype.onmousemove=function(t){this._pointerMove(t,t)},i.prototype.onMSPointerMove=i.prototype.onpointermove=function(t){t.pointerId==this.pointerIdentifier&&this._pointerMove(t,t)},i.prototype.ontouchmove=function(t){var n=this.getTouch(t.changedTouches);n&&this._pointerMove(t,n)},i.prototype._pointerMove=function(t,n){this.pointerMove(t,n)},i.prototype.pointerMove=function(t,n){this.emitEvent("pointerMove",[this,t,n])},i.prototype.onmouseup=function(t){this._pointerUp(t,t)},i.prototype.onMSPointerUp=i.prototype.onpointerup=function(t){t.pointerId==this.pointerIdentifier&&this._pointerUp(t,t)},i.prototype.ontouchend=function(t){var n=this.getTouch(t.changedTouches);n&&this._pointerUp(t,n)},i.prototype._pointerUp=function(t,n){this._pointerDone(),this.pointerUp(t,n)},i.prototype.pointerUp=function(t,n){this.emitEvent("pointerUp",[this,t,n])},i.prototype._pointerDone=function(){this.isPointerDown=!1,delete this.pointerIdentifier,this._unbindPostStartEvents(),this.pointerDone()},i.prototype.pointerDone=e,i.prototype.onMSPointerCancel=i.prototype.onpointercancel=function(t){t.pointerId==this.pointerIdentifier&&this._pointerCancel(t,t)},i.prototype.ontouchcancel=function(t){var n=this.getTouch(t.changedTouches);n&&this._pointerCancel(t,n)},i.prototype._pointerCancel=function(t,n){this._pointerDone(),this.pointerCancel(t,n)},i.prototype.pointerCancel=function(t,n){this.emitEvent("pointerCancel",[this,t,n])},i.getPointerPoint=function(t){return{x:void 0!==t.pageX?t.pageX:t.clientX,y:void 0!==t.pageY?t.pageY:t.clientY}},i});
!function(t,n){"use strict";"function"==typeof define&&define.amd?define(["eventie/eventie","unipointer/unipointer"],function(i,e){return n(t,i,e)}):"object"==typeof exports?module.exports=n(t,require("eventie"),require("unipointer")):t.Unidragger=n(t,t.eventie,t.Unipointer)}(window,function(t,n,i){"use strict";function e(){}function o(t){t.preventDefault?t.preventDefault():t.returnValue=!1}function r(t){for(;t!=document.body;)if(t=t.parentNode,"A"==t.nodeName)return t}function a(){}function s(){return!1}a.prototype=new i,a.prototype.bindHandles=function(){this._bindHandles(!0)},a.prototype.unbindHandles=function(){this._bindHandles(!1)};var d=t.navigator;a.prototype._bindHandles=function(t){t=void 0===t?!0:!!t;var i;i=d.pointerEnabled?function(n){n.style.touchAction=t?"none":""}:d.msPointerEnabled?function(n){n.style.msTouchAction=t?"none":""}:function(){t&&c(a)};for(var e=t?"bind":"unbind",o=0,r=this.handles.length;r>o;o++){var a=this.handles[o];this._bindStartEvent(a,t),i(a),n[e](a,"click",this)}};var p="attachEvent"in document.documentElement,c=p?function(t){"IMG"==t.nodeName&&(t.ondragstart=s);for(var n=t.querySelectorAll("img"),i=0,e=n.length;e>i;i++){var o=n[i];o.ondragstart=s}}:e,u=a.allowTouchstartNodes={INPUT:!0,A:!0,BUTTON:!0,SELECT:!0};return a.prototype.pointerDown=function(t,n){this._dragPointerDown(t,n);var i=document.activeElement;i&&i.blur&&i.blur(),this._bindPostStartEvents(t),this.emitEvent("pointerDown",[this,t,n])},a.prototype._dragPointerDown=function(t,n){this.pointerDownPoint=i.getPointerPoint(n);var e=t.target.nodeName,a="touchstart"==t.type&&(u[e]||r(t.target));a||"SELECT"==e||o(t)},a.prototype.pointerMove=function(t,n){var i=this._dragPointerMove(t,n);this.emitEvent("pointerMove",[this,t,n,i]),this._dragMove(t,n,i)},a.prototype._dragPointerMove=function(t,n){var e=i.getPointerPoint(n),o={x:e.x-this.pointerDownPoint.x,y:e.y-this.pointerDownPoint.y};return!this.isDragging&&this.hasDragStarted(o)&&this._dragStart(t,n),o},a.prototype.hasDragStarted=function(t){return Math.abs(t.x)>3||Math.abs(t.y)>3},a.prototype.pointerUp=function(t,n){this.emitEvent("pointerUp",[this,t,n]),this._dragPointerUp(t,n)},a.prototype._dragPointerUp=function(t,n){this.isDragging?this._dragEnd(t,n):this._staticClick(t,n)},a.prototype._dragStart=function(t,n){this.isDragging=!0,this.dragStartPoint=a.getPointerPoint(n),this.isPreventingClicks=!0,this.dragStart(t,n)},a.prototype.dragStart=function(t,n){this.emitEvent("dragStart",[this,t,n])},a.prototype._dragMove=function(t,n,i){this.isDragging&&this.dragMove(t,n,i)},a.prototype.dragMove=function(t,n,i){this.emitEvent("dragMove",[this,t,n,i])},a.prototype._dragEnd=function(t,n){this.isDragging=!1;var i=this;setTimeout(function(){delete i.isPreventingClicks}),this.dragEnd(t,n)},a.prototype.dragEnd=function(t,n){this.emitEvent("dragEnd",[this,t,n])},a.prototype.onclick=function(t){this.isPreventingClicks&&o(t)},a.prototype._staticClick=function(t,n){"INPUT"==t.target.nodeName&&"text"==t.target.type&&t.target.focus(),this.staticClick(t,n)},a.prototype.staticClick=function(t,n){this.emitEvent("staticClick",[this,t,n])},a.getPointerPoint=function(t){return{x:void 0!==t.pageX?t.pageX:t.clientX,y:void 0!==t.pageY?t.pageY:t.clientY}},a.getPointerPoint=i.getPointerPoint,a});
!function(t,e){"use strict";"function"==typeof define&&define.amd?define(["unipointer/unipointer"],function(n){return e(t,n)}):"object"==typeof exports?module.exports=e(t,require("unipointer")):t.TapListener=e(t,t.Unipointer)}(window,function(t,e){"use strict";function n(t){this.bindTap(t)}n.prototype=new e,n.prototype.bindTap=function(t){t&&(this.unbindTap(),this.tapElement=t,this._bindStartEvent(t,!0))},n.prototype.unbindTap=function(){this.tapElement&&(this._bindStartEvent(this.tapElement,!0),delete this.tapElement)};var i=void 0!==t.pageYOffset;return n.prototype.pointerUp=function(n,o){var p=e.getPointerPoint(o),r=this.tapElement.getBoundingClientRect(),s=i?t.pageXOffset:document.body.scrollLeft,u=i?t.pageYOffset:document.body.scrollTop,f=p.x>=r.left+s&&p.x<=r.right+s&&p.y>=r.top+u&&p.y<=r.bottom+u;f&&this.emitEvent("tap",[this,n,o])},n.prototype.destroy=function(){this.pointerDone(),this.unbindTap()},n});
...
FlickityDocs.modules.reposition=function(i){"use strict";var e=i.querySelector(".gallery"),t=new Flickity(e);t.on("staticClick",function(i,e,o,c){c&&(classie.toggle(c,"is-expanded"),t.reposition())})};
